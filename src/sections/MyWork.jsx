...
const MyWork = () => {
  ...
  return (
    ...
    <svg className='block relative' data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
      ...
      <div className={`max-w-[1170px] m-auto flex flex-col justify-between ${scrollPosition > 1050 ? 'visible animate-fade-up animate-once animate-duration-1000 animate-ease-in-out animate-normal animate-fill-backwards' : 'invisible'} `}>
          <div className='w-[100%]'>
              <h1>My Work</h1>
          </div>
