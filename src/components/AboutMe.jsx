...
const AboutMe = () => {
  ...
  return (
    <div className='max-w-[1170px] mt-0 mb-0 mr-auto ml-auto pt-0 pb-0 pr-[15px] pl-[15px] text-left flex justify-between md:flex-col md:justify-center md:items-center'>
