  ...
  return (
    <div className='max-w-[1170px] h-screen flex items-center justify-center m-auto md:flex-col'>
        ...
        <div className='w-[50%] h-[50%] relative md:w-full md:fluid-md'>
          ...
          <img src="C:\Users\eugene\Desktop\Portfolio_website\src\assets\images\iPhone_Laying_R.png" alt="Phone" className='w-[40%] absolute bottom-[25%] left-[0%] lg:bottom-[25%] md:w-[25%] md:bottom-[40%] md:left-[20%] animate-fade-up animate-once animate-duration-1000 animate-delay-500 animate-ease-in-out animate-normal animate-fill-backwards'/>
