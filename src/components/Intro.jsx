  ...
  return (
    <div className='max-w-[1170px] h-screen flex items-center justify-center m-auto md:flex-col'>
        ...
        <div className='w-[50%] h-[50%] relative md:w-full md:fluid-md'>
          ...
          <img src={Phone} alt="Phone" className='w-[40%] absolute bottom-[25%] left-[0%] lg:bottom-[25%] md:w-[25%] md:bottom-[40%] md:left-[20%] animate-fade-up animate-once animate-duration-1000 animate-delay-500 animate-ease-in-out animate-normal animate-fill-backwards'/>
          <img src={Mouse} alt="Mouse" className='w-[40%] absolute bottom-[25%] left-[50%] lg:bottom-[25%] md:w-[25%] md:bottom-[40%] md:left-[55%] animate-fade-up animate-once animate-duration-1000 animate-delay-1000 animate-ease-in-out animate-normal animate-fill-backwards  '/>
